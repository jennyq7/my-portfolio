...
function Projects ()  {
    return (
        <div className="projects p-2 pt-3 pl-3 bg-greyColor">
            ...
            <section>
                <div>
                   <img className="h-1/5 w-full" src={RecipeBox} alt="screenshot of recipe box main page"/>
                   <div>
                        ...
                        <aside>Click <a href="https://brave-grass-0f08f400f.3.azurestaticapps.net/recipes">here</a> to go to my recipe site</aside> 
                    </div>
                </div>
            </section>
        </div>

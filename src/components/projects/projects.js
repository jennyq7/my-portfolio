    ...
    return (
        <div className="projects p-2 pt-3 pl-3 bg-greyColor">
            ...
            <section className="md:flex md:flex-wrap">
                ...
                <div className="pb-3 md:flex md:gap-1 xl:w-2/4">
                   <div className="w-full md:w-4/12 h-auto">
                      <img className="mx-auto md:m-0 h-20v md:h-40v md:w-11/12 object-center md:object-contain" src={Calc} alt="screenshot of calculator"/>
                   </div>
                   <div className="mx-auto md:self-center">
